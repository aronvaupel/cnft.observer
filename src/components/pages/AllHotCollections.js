...
import AllHotCollectionsRedux from "../components/AllHotCollectionsRedux";
...
const AllHotCollections = function () {
      ...
      >
        <div id="headline-adjust">
          <Reveal
            ...
            triggerOnce
          >
            <h1 className="col-white outline">All Hot Collections</h1>
          </Reveal>
          ...
          <Reveal
            ...
            triggerOnce
          >
            <p className="lead col-white outline">Check out the most popular collections!</p>
          </Reveal>
        </div>
      </section>
      ...
      <section className="container  no-top no-bottom">
        ...
        <div className="row">
          <div className="col-lg-12">
            ...
            <AllHotCollectionsRedux  showLoadMore={false} />
...
export default AllHotCollections;
