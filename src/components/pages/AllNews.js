...
import AllNewsRedux from "../components/AllNewsRedux";
      ...
      >
        <div id="headline-adjust">
          <Reveal
            ...
            triggerOnce
          >
            <h1 className="col-white outline">All News and Articles</h1>
          </Reveal>
          ...
          <Reveal
            ...
            triggerOnce
          >
            <p className="lead col-white outline">Get the Latest Updates and Important Information!</p>
          </Reveal>
        </div>
      </section>
      ...
      <section className="container  no-top no-bottom">
        ...
        <div className="row">
          <div className="col-lg-12">
            ...
            <AllNewsRedux  showLoadMore={false} />
