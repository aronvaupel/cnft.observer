...
const ColumnCollectionDetailsRedux = () => {

    const dispatch = useDispatch();

    const nftItems = useSelector(selectors.CollectionItems);
    ...
    useEffect(() => {
        dispatch(actions.fetchCollectionDetailsBreakdown());
    }, [dispatch]);
...
export default memo(ColumnCollectionDetailsRedux);