...
// Observe the market. Gather intel. Make decisions.
 ...
 <div className="container">
    <div className="row align-items-center">
          <div className="col-md-6">
              ...
              <h1 className="col-white">Observe the CNFT space. Gather real intelligence. Make best decisions.</h1>
              </Reveal>
              <Reveal className='onStep' keyframes={fadeInUp} delay={600} duration={900} triggerOnce>
              <p className="lead col-white">
              Gather all necessary information, like news, drops, projects, wallets and much more valuable resources!
              </p>
              </Reveal>
