...
export const fetchTopProjectsRanking = () => async (dispatch) => {
  ...
  dispatch(actions.getTopProjectRanking.request(Canceler.cancel));
  ...
  try {
    ...
    dispatch(actions.getTopProjectRanking.success(data));
  } catch (err) {
    dispatch(actions.getTopProjectRanking.failure(err));
  }
};
